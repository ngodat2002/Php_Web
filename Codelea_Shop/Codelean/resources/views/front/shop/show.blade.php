                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="product-details">
                            ...
                            <ul class="pd-tags">
                                <li><span>CATEGORIES</span>: More Accessories, Wallests & Cases </li>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="tab-2" role="tabpanel">
                                <div class="specification-table">
                                    <table>
                                        <tr>
                                            <td class="p-catagory">Customer Raiting</td>
                                            <td>
                                                <div class="pd-rating">
                                                    @for($i =1;$i<=5;$i++)
                                                        @if($i<=$avgRating)
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-6">
                @include('front.shop.components.product-item',['product'=>$relatedProduct])
