        ...
        <div class="row">
          ...
          <div class="filter-control">
              <ul>
                  ...
                  <li class="item" data-tag=".Accessorise" data-category="women">Accessorise</li>
              </ul>
          </div>
            <div class="product-slider owl-carousel women">
              @foreach($womenProducts as $womenProduct)
                    @include('front.shop.components.product-item',['product'=>$womenProduct])
                @endforeach
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-8 offset-lg-1">
            <div class="filter-control">
              <ul>
                  ...
                  <li class="item" data-tag=".Accessorise" data-category="men">Accessorise</li>
              </ul>
            </div>
            <div class="product-slider owl-carousel men">
                @foreach($menProducts as $menProduct)
                    @include('front.shop.components.product-item',['product'=>$menProduct])
                @endforeach
            </div>
          </div>
        </div>
