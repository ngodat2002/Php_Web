...
<head>
    ...
    <title>Order Notification | Food Mate</title>
...
<style>
    *{
    ...
    body{
        background: hsla(169, 100%, 50%, 1);

        background: linear-gradient(90deg, hsla(169, 100%, 50%, 1) 11%, hsla(186, 100%, 69%, 1) 66%);

        background: -moz-linear-gradient(90deg, hsla(169, 100%, 50%, 1) 11%, hsla(186, 100%, 69%, 1) 66%);

        background: -webkit-linear-gradient(90deg, hsla(169, 100%, 50%, 1) 11%, hsla(186, 100%, 69%, 1) 66%);

    }
</style>

<body
    style="background-color: #e7eff8; font-family: 'open sans', sans-serif; margin-top: 0; box-sizing: border-box; line-height: 1.5;">
    ...
    <div class="container" style="background-color: #e7eff8; width: 600px; margin: auto;">
        <div class="col-12 mx-auto" style="width: 580px;  margin: 0 auto;">
            ...
            <div class="row"
                ...
                <h1 class="pl-2"
                    style="color: orange; line-height: 30px; float: left; padding-left: 20px; font-size: 45px; font-weight: 700; font-family: 'Nunito', sans-serif;">
                    Food <span style="color: #719a0a">Mate</span>
                        ...
                        @if($order->payment_type == "online_payment")
                            ...
                            <td class="pl-3" style=" padding-left:10px;">
                                <img src="https://vnpay.vn/wp-content/uploads/2020/07/Logo-VNPAYQR-update.png"
                                     width="120px" style="margin-top: 10px;" alt="">
                            </td>
                        @endif
            ...
            <div class="row mt-2 mb-4" style="margin-top: 15px; margin-bottom: 25px;">
                <div class="container-fluid">
                    ...
                    <div class="row pl-3 py-2" style="background-color: #fff; padding: 10px 20px;">
                        <p>You can check your order (dish, meal, category...)
                            before paying and can refuse if you feel the order is incorrect.</p>

                        <p>If you have any feedback about the food and service of the store,
                            I will be able to fix it as soon as possibl e to give customers the
                            best experience when coming to FoodMate.</p>

                        <p>You can refer to the Help Center page or contact the store by leaving a message at the Contact page or sending a message here.
                            Hotline 0394480757 (8:00 AM - 10:00 PM, both Saturday and Sunday).</p>

                        <b>FoodMate thank you very much <3.</b>
                    </div>
                </div>
            </div>
