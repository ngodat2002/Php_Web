                                ...
                                <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview">
                                    <div class="row">
                                        <div class="col-lg-12 grid-margin stretch-card">
                                            <div class="card">
                                                <div class="card-body">
                                                    <h2 class="card-title">List Food</h2>
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            @foreach($products as $product)
                                                                <tr class="table-product">
                                                                    <td>{{$product->id}}</td>
                                                                    <td>{{$product->name}}</td>
                                                                    <td>{{$product->restaurants->name}}</td>
                                                                    <td>${{$product->price}}</td>
                                                                    <td><img src="front/img/menu/{{$product->image}}" alt="" style="width: 100px;height: 140px;border-radius: 0"></td>
                                                                    <td>
                                                                        <a href="{{url('/update-food',$product->id)}}"><i class="mdi mdi-border-color" style="font-size: 20px;color: #1F3BB3"></i></a>
                                                                        <a href="{{url('/delete',$product->id)}}"><i class="mdi mdi-delete" style="font-size: 20px;padding: 10px;color: #1F3BB3"></i></a>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                            </tbody>
