                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <form action="{{url('/upload')}}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div>
                                                            <label>Meal-id: </label>
                                                            <input style="color:#1F3BB3;" type="text" name="meal_id" placeholder="Write a meal id" required>
                                                        </div>
                                                        <div>
                                                            <label>Category-id: </label>
                                                            <input style="color:#1F3BB3;" type="text" name="product_categories_id" placeholder="Write a category id" required>
                                                        </div>
                                                        <div>
                                                            <label>Restaurant-id: </label>
                                                            <input style="color:#1F3BB3;" type="text" name="restaurant_id" placeholder="Write a category id" required>
                                                        </div>
                                                        <div>
                                                            <label>Name: </label>
                                                            <input style="color:#1F3BB3;" type="text" name="name" placeholder="Write a name" required>
                                                        </div>
                                                        <div>
                                                            <label>Quantity: </label>
                                                            <input style="color:#1F3BB3;" type="text" name="qty" placeholder="quantity" required>
                                                        </div>
                                                        <div>
                                                            <label>Price: </label>
                                                            <input style="color:#1F3BB3;" type="text" name="price" placeholder="price" required>
                                                        </div>
                                                            <div>
                                                                <label>Description: </label>
                                                                <input style="color:#1F3BB3;" type="text" name="description" placeholder="description" required>
                                                            </div>
                                                        <div>
                                                            <label>Image</label>
                                                        ...
                                                        <div>
                                                            <label>Rate: </label>
                                                            <input style="color:#1F3BB3;" type="text" name="rate" placeholder="rate" required>
                                                        </div>
                                                        <div>
