...
<div class="container-scroller">
    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
            ...
            <div>
                <a class="navbar-brand brand-logo" href="{{'redirects'}}">
                    <h2>FoodMate</h2>
                </a>
            </div>
        </div>
            ...
            <ul class="navbar-nav">
                <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                    @foreach($admins as $admin)
                        <h1 class="welcome-text">Hello, {{$admin->name}}<span class="text-black fw-bold"></span></h1>
                    @endforeach
                </li>
            </ul>
    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{url('orders')}}" aria-expanded="false" aria-controls="auth">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <form action="{{url('/update',$products->id)}}" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div>
                                                            <label>Meal-id: </label>
                                                            <input style="color:#1F3BB3;" type="text" name="meal_id" value="{{$products->meal_id}}" required>
                                                        </div>

                                                        <div>
                                                            <label>Category-id: </label>
                                                            <input style="color:#1F3BB3;" type="text" name="product_categories_id" value="{{$products->product_categories_id}}" required>
                                                        </div>

                                                        <div>
                                                            <label>Restaurant-id: </label>
                                                            <input style="color:#1F3BB3;" type="text" name="restaurant_id" value="{{$products->restaurant_id}}" required>
                                                        </div>

                                                        <div>
                                                            <label>Name: </label>
                                                            <input style="color:#1F3BB3;" type="text" name="name" value="{{$products->name}}" required>
                                                        </div>

                                                        <div>
                                                            <label>Quantity: </label>
                                                            <input style="color:#1F3BB3;" type="text" name="qty" value="{{$products->qty}}" required>
                                                        </div>

                                                        <div>
                                                            <label>Price: </label>
                                                            <input style="color:#1F3BB3;" type="text" name="price" value="{{$products->price}}" required>
                                                        </div>
                                                            <div>
                                                                <label>Description: </label>
                                                                <input style="color:#1F3BB3; width: 100%" type="text" name="description" value="{{$products->description}}" required>
                                                            </div>

                                                        <div>
                                                            <label>Old Image</label>
                                                            <img height="200" width="200" src="front/img/menu/{{$products->image}}">
                                                        </div>
                                                        ...
                                                        <div>
                                                            <label>Rate: </label>
                                                            <input style="color:#1F3BB3;" type="text" name="rate" value="{{$products->rate}}" required>
                                                        </div>
                                                        <div>
