    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
                ...
                <li class="nav-item">
                    <a class="nav-link"  href="{{url('create')}}" aria-expanded="false" aria-controls="tables">
                ...
                <li class="nav-item">
                    <a class="nav-link"  href="{{url('orders')}}" aria-expanded="false" aria-controls="form-elements">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            ...
                                                            <a href="{{url('orders')}}" class="btn btn-warning btn-rounded btn-fw" style="color: #fff !important; margin-top: 10px">Back</a>
                                                        </div>
                                                        <div class="col-md-9">
                                                            <table class="table" style="margin-top: 25px">
                                                                ...
                                                                @foreach($orders->orderDetails as $order)
                                                                    <tr style="text-align: center">
                                                                        ...
                                                                        <td><img src="front/img/menu/{{$order->products->image}}" alt="" style="width: 140px;height: 160px;border-radius: 0"></td>
                                                                    </tr>
                                                                @endforeach
                                                                </tbody>
                                                            </table>
                                                            <h4> Total:<span style="float: right">${{$orders->total_price}}</span></h4>
                                                            <br><br>
                                                            ...
                                                            <div class="form-group">
                                                                <form action="{{url('update-order',$orders->id)}}" method="POST">
                                                                    @csrf
                                                                    @method('PUT')
                                                                <select class="js-example-basic-single w-50 border-2" name="order_status">
                                                                    <option selected>Open select options</option>
                                                                    <option {{$orders->status=='0'?'selected':''}} value="0">Pending</option>
                                                                    <option {{$orders->status=='1'?'selected':''}} value="1">Accept</option>
                                                                    <option {{$orders->status=='2'?'selected':''}} value="2">Cancel</option>
                                                                </select><br>
                                                                    <button type="submit" class="btn btn-warning btn-rounded btn-fw mt-4" style="color: #fff !important;">Update</button>
                                                                </form>
                                                            </div>
                                                        </div>
                                                    </div>
