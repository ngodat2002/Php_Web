    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-top">
            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <form class="search-form" action="{{url('order-history')}}" method="get">
                        <i class="icon-search"></i>
                        <input type="search" value="{{request('search')}}" name="search" class="form-control" placeholder="Search Here" title="Search here">
                    </form>
                </li>
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <h2 class="card-title">List Orders
                                                        <a href="{{'orders'}}" class="btn btn-warning btn-rounded btn-fw float-right" style="color: #fff !important;">Back Order</a>
                                                    </h2>
