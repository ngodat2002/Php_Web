    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-top">
            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <form class="search-form" action="{{url('orders')}}">
                        <i class="icon-search"></i>
                        <input type="search" name="search" value="{{request('search')}}" class="form-control" placeholder="Search Here" title="Search here">
                    </form>
                </li>
                                ...
                                <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 grid-margin stretch-card">
                                            <div class="card">
                                                <div class="card-body">
                                                    <h2 class="card-title">List Orders
                                                        <a href="{{route('order-history')}}" class="btn btn-warning btn-rounded btn-fw float-right" style="color: #fff !important;">Order History</a>
                                                    </h2>
...
{{--                                                                        <td>{{$order->status=='0'?'Pending':'Completed'}}</td>--}}
                                                                        ...
                                                                        @elseif($order->status=='2')
                                                                            <td>Cancel</td>
                                                                        @endif
                                                                        <td> <a href="{{url('/view',$order->id)}}" class="btn btn-warning btn-rounded btn-fw" style="color: #fff !important;" >View Order</a></td>
                                                                    </tr>
                                                                @endforeach
                                                            </tbody>
                                                        </table>
