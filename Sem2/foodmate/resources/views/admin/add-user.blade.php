    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{url('restaurants')}}" aria-expanded="false" aria-controls="auth">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <form action="{{url('/upload_user')}}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div>
                                                            <label>Name: </label>
                                                            <input style="color:#1F3BB3;padding: 10px 10px;" type="text" name="name" placeholder="Write a name" required>
                                                        </div>
                                                        <div>
                                                            <label>Email: </label>
                                                        <input style="color:#1F3BB3;" type="email" name="email" placeholder="Write a email" required>
                                                        </div>
                                                        <div>
                                                            <label>Phone: </label>
                                                            <input style="color:#1F3BB3;" type="text" name="phone" placeholder="Write phone" required>
                                                        </div>
                                                        <div>
                                                            <label>Address: </label>
                                                            <input style="color:#1F3BB3;" type="text" name="address" placeholder="Write address" required>
                                                        </div>
                                                        <div>
                                                            <label>Password: </label>
                                                            <input style="color:#1F3BB3;" type="password" name="password" placeholder="Write address" required>
                                                        </div>
                                                        <div>
